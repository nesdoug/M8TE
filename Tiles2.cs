namespace M8TE
{
    ...
    // note, we aren't using the last 4 rows of tiles on the last tileset
    // 1024 - 64 tiles = 960 tiles
    // but, most of the code is set up with the assumption of 1024 tiles
        ...
        public static class Tiles
    {
        ...
        public static void select_all()
        {
            ...
            if(Form1.tile_set == 3)
            {
                trans_h = 12;
                Form1.BE_y2 = 12;
                // fewer tiles allowed on the last tileset
            }
        }
